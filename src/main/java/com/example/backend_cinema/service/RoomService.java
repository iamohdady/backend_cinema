...
public class RoomService {
    ...
    public List<RoomEntity> findAvailableRoomsByDayTime(Integer daytimeId) throws Exception {
        if (daytimeId != null) {
            return mysql.selectList(CinemaSql.findAvailableRoomsByDayTime(daytimeId), RoomEntity.class);
        }
        throw new BadRequestException("Daytime ID is null");
    }
